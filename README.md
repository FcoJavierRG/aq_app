...
# 🏗️ Floor Plan Accessibility Analyzer (Access Quotient Tool)
...
It can be used as a **Jupyter Notebook**, a **standalone Python module**, or as a **web application** powered by [Voila](https://voila.readthedocs.io/).
